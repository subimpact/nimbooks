...
export const APP_VERSION_LABEL = 'v1.16.0'
...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-09-14',
    items: [
      'A guided tour walks you through the app the first time: a small coach card points at your balance, sending, cashlinks, payment requests, history, receipts, staking and exports, and demo replays are one flag away',
  ...
  },
  {
    ...
    items: [
      ...
      'Error messages that still claimed staking needs Nimiq Pay now point to both ways in: Nimiq Pay or a signed-in Nimiq Hub',
    ],
  },
  {
    version: '1.14.0',
    ...
    items: [
      ...
      'The signing library behind browser staking downloads once, the first time you open a staking surface in a Hub session, and Nimiq Pay users never load it',
