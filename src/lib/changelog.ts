...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-09-11',
    items: [
      'Printouts stay clean: the hexagon field no longer follows statements, receipts and exports onto paper',
      'Reduced motion done right: the still background now follows theme changes and window resizes',
      'Window resizes no longer reshuffle the hexagons, and the field runs at a steady, battery-friendly pace',
    ],
  },
  {
    version: '1.11.1',
    date: '2026-09-11',
    items: [
      'The hexagon field now flows behind the whole app, not just the landing: every screen sits on the living honeycomb, softly veiled so your books stay the focus',
      'Connect screen polish: the panel rests on a frosted glass card, the wordmark gains a gradient and shadow, and the corner buttons get their own glass pills, so nothing fights the moving hexes',
    ],
  },
  {
    version: '1.11.0',
  ...
  },
  {
    ...
    date: '2026-09-11',
    items: [
      'Sends celebrate: a confetti burst when your payment is confirmed on chain, not merely when the wallet hands it back — the sheet stays open until you tap Done',
    ],
  },
  {
    version: '1.8.0',
